...
## Screenshots Source
Illustrative UI mockups live in `docs/screenshots/` so the README always renders without relying on external CDNs.

---
Feel free to open an issue or reach out to the authors for questions, enhancements, or bug reports.
